...
@CucumberOptions (
        ...
        features = {"src/test/resources/features/ErkanCihan/Automation_AnaSayfa.feature"},         // feature yolu alinirken content rootdan baslanir
...
public class ErkanRunner extends AbstractTestNGCucumberTests{
