...
@CucumberOptions(
        ...
        features = {"src/test/resources/features/ErkanCihan/ErkanCihan.feature"},         // feature yolu alinirken content rootdan baslanir
...
public class RunnerErkanCihan extends AbstractTestNGCucumberTests {
}
