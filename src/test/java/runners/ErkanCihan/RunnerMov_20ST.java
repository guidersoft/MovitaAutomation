...
@CucumberOptions(
        ...
        features = {"src/test/java/stepdefs/Mov_20ST.java"},         // feature yolu alinirken content rootdan baslanir
        ...
        //tags = "",    // @login tagli senaryolar calistirilin
        plugin = {"pretty",
...
public class RunnerMov_20ST extends AbstractTestNGCucumberTests {
}
